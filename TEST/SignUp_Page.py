...
@pytest.mark.parametrize("username, em, password1, password2", [
    ...
    ("Normal User", "21201201@uap-bd.edu", "abcdabcd", "abcdabcd"),
    ("Normal_User", "21201201@uap-bd.edu", "abcdabc", "abcdabcd"),
    ("Normal_User", "21201201@uap-bd.edu", "wrong", "wrong"),
    ("Normal_User_1", "21201201@uap-bd.edu", "abcdabcd", "abcdabcd"),
])
